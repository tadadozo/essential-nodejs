...
let start = 12; //indicates where to start the episode with index 0..n, if start is null we start with index 0 (the first one)
let length = 3; //the number of episodes starting at start, if length is null then all are download starting at start
